...
<body>
 ...
 <div class="back_icon" style="margin-left:80px;margin-top: 15px;">
    ...
    <div class="product_page" style="margin-top:-50px">        <div class="row">
            <div class="col">

                <div class="slider">
                    <div class="product">

                        <img src="images/16-1.png" alt="" onclick="clickme(this)">
                        <img src="images/16-2.png" alt="" onclick="clickme(this)">
                        <img src="images/16-3.png" alt="" onclick="clickme(this)">
                        <img src="images/16-4.png" alt="" onclick="clickme(this)">

                    </div>
                    <div class="preview">
                        <img src="images/16-1.png" id="imagebox" alt="">
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="content">
                    ...
                    <h2>RUHAAN'S</h2>
                   <div class="caption">
                      <p>silk sarees with stone work</p>
                   </div>
                   <div class="cost">
                       <h3>₹600</h3> 
